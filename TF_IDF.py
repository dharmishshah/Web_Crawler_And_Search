...
invertedIndexFile = current_directory + "/1_inverted_index.txt"

# source file of unigram term count of documents
termCountFile = current_directory + "/1_term_count.txt"
...
def main(queryId, query,dir):
    lm_dirichlet(queryId, query,dir)
...
def lm_dirichlet(queryId, query, dir):
    readTermCount()
    readInvertedIndex()
